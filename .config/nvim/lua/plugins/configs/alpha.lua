...
local options = {
  ...
  buttons = {
    type = "group",
    val = {
      button(", f f", "  Find Word  ", ":Telescope live_grep<CR>"),
      button(", f a", "  Find all  ", ":Telescope find_files follow=true no_ignore=true hidden=true <CR>"),
      button(", r r", "  Find File  ", ":Telescope find_files<CR>"),
